<aside class="aside-menu">
  ...
  <div class="tab-content">
      <div class="tab-pane active" id="timeline" role="tabpanel">
          ...
          <div id="{{ $notification->id }}" class="callout callout-warning m-a-0 p-y-1">
            <div data-id="{{ $notification->id }}" style="width: 8px;" class="avatar pull-xs-right remove-notification">
